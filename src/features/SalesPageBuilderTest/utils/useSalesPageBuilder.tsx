...
export const useSalesPageBuilder = () => {
  useEffect(() => {
    const payload = window.location.href.includes("page=1") ? page1 : page2;
    const registerButtonHref = payload.registerButtonHref;
    const creatorUuid = payload?.creatorUuid;
    const salePageUuid = payload?.salePageUuid;
